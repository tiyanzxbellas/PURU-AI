...
export const api = {
  ...
  getUsage: () => j('GET', API + '/usage'),
  clearUsage: () => j('POST', API + '/usage'),
  getLogs: () => j('GET', API + '/logs'),
  clearLogs: () => j('POST', API + '/logs'),
  listCombos: () => j('GET', API + '/combos'),
  saveCombo: (body) => j('POST', API + '/combos', body),
  deleteCombo: (id) => j('POST', API + '/combos/delete', { id }),
  activateCombo: (id) => j('POST', API + '/combos/activate', { id }),
  listProviders: () => j('GET', API + '/providers'),
  saveProvider: (body) => j('POST', API + '/providers', body),
  deleteProvider: (id) => j('POST', API + '/providers/delete', { id }),
  checkProvider: (body) => j('POST', API + '/providers/check', body),
}
